...
public class SettingFragment extends Fragment {
	...
	LinearLayout baseLayout_viewbill;
	String accountName = "";
	Button resetButton;
	...
	{
		return inflater.inflate(R.layout.settingfragment, containter, false);
	}
	...
	public void onStart()
	{
		...
		baseLayout_viewbill = (LinearLayout) getActivity().findViewById(
	...
	private void setLimits(Context context)
	{
		...
		limit.setDaily_limit(Double.parseDouble(dailyLimitTextView.getText()
				.toString()));
		limit.setWeekly_limit(Double.parseDouble(weeklyLimitTextView.getText()
				.toString()));
		limit.setMonthly_limit(Double.parseDouble(monthlyLimitTextView
				.getText().toString()));
		limit.setYearly_limit(Double.parseDouble(yearlyLimitTextView.getText()
				.toString()));
		...
		editor.commit();
		Toast.makeText(context, "Limits Saved", Toast.LENGTH_SHORT).show();
	}
